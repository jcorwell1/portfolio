...
public class MyMainTest {
   ...
   @Test
    ...
    public void mainTest27() throws Exception {
        ...
        String args[] = {"00000000090wq0", inputFile.getPath()};
        Main.main(args);

        assertEquals("Usage: Capitalize  [-l] [-e] [-s] [string] [-x] [-c] [boolean] <filename>", errStream.toString().trim());
    }

    /**Type D faiure! cant pass an empty string as an argument for -s parameter
    java.lang.ArrayIndexOutOfBoundsException
    the code should just try to catch this situation and return an error message
     **/
    @Test
    ...
    /**Type D faiure! cant pass null as a parameter
    java.lang.NullPointerException
    the code should just try and catch this situation and return an error message
     **/
    ...
    public void mainTest29() throws Exception {
        ...
        String args[] = {null, inputFile.getPath()};
        Main.main(args);
        String expected = "appblees666! ";
    ...
    /**Type D faiure!
    java.lang.NullPointerException
     Code doesnt check for null delimeter for -s
    the code should just try and catch this situation and return an error message
    **/
    ...
    public void mainTest30() throws Exception {
        ...
        String args[] = {"-s",null, inputFile.getPath()};
        Main.main(args);
        String expected = "-- -- -- --";
